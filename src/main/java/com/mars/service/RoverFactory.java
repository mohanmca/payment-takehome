...
public class RoverFactory {
  ...
  private static final RoverFactory factory = new RoverFactory();
  ...
  public Rover createRover(String position) {
     ...
     if(isValidCoordinate(coordinates)) {
        return createRover(coordinates[2].charAt(0), Integer.parseInt(coordinates[0]), Integer.parseInt(coordinates[1]));
     }
